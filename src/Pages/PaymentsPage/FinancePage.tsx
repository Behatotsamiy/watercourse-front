          ...
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
              ...
              <div className="lg:col-span-2 bg-white rounded-[24px] border border-slate-100 p-6">
                <div className="flex justify-between items-start mb-1">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="w-7 h-7 flex items-center justify-center rounded-lg bg-slate-100 hover:bg-slate-200 transition"
                    >
                      <ChevronLeft size={14} />
                    </button>
                    <span className="text-xs font-black text-slate-600">
                      {MONTHS[reportDate.month - 1]}
                    </span>
                    <button
                      onClick={() => shiftMonth(1)}
                      className="w-7 h-7 flex items-center justify-center rounded-lg bg-slate-100 hover:bg-slate-200 transition"
                ...
                {monthly?.payments?.graphData?.length > 0 ? (
                  ...
                  <div className="h-48 flex items-center justify-center text-slate-300 font-bold text-sm">
              ...
              <div className="bg-white rounded-[24px] border border-slate-100 p-6 flex flex-col">
                ...
                {pieData.length > 0 ? (
                  ...
                  <div className="flex-1 flex items-center justify-center text-slate-300 font-bold text-sm">
                    Ma'lumot yo'q
                  </div>
                )}
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
              ...
              <div className="bg-white rounded-[24px] border border-slate-100 p-6">
                ...
                <div className="flex flex-col gap-2">
                  {monthly?.debtors
                    ?.slice(0, showAllDebtors ? 10 : 3)
                    .map((s: any) => (
                      <div
                        key={s.id}
                        className="flex items-center justify-between p-3 hover:bg-red-50/50 rounded-xl transition"
                      >
                        <div className="flex items-center gap-3">
                  ...
                  {!monthly?.debtors?.length && (
                    <div className="py-8 text-center text-slate-300 font-bold text-sm">
            ...
            <div className="flex items-center justify-center gap-2 mt-6 text-slate-300">
              ...
              <span className="text-[10px] font-bold">
                Ma'lumotlar himoyalangan va maxfiy
              </span>
            </div>
          </>
        ))}
      ...
      {tab === "payments" && (
        <>
          ...
          <div className="relative mb-4">
            ...
            <input
              type="text"
              placeholder="O'quvchi bo'yicha qidiruv..."
              value={search}
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-slate-50 border-b border-slate-100">
                    {["O'quvchi", "To'lov turi", "Summa", "Sana", ""].map(
                      (h) => (
                        <th
                          key={h}
                          className="px-5 py-4 text-left text-[10px] font-black text-slate-400 uppercase tracking-widest"
                        >
                          {h}
                        </th>
                      ),
                ...
                <tbody className="divide-y divide-slate-50">
                  ...
                  {filtered.length === 0 && (
                    <tr>
                      <td
                        colSpan={5}
                        className="px-5 py-12 text-center text-slate-300 font-bold"
                      >
                        To'lovlar topilmadi
                      </td>
                    </tr>
